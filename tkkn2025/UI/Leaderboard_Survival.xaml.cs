...
{
    /// <summary>
    /// Leaderboard for Survival Mode games
    /// </summary>
    public partial class Leaderboard_Survival : UserControl
    {
        public Leaderboard_Survival()
        {
            InitializeComponent();
        }
        ...
        /// </summary>
        /// <param name="games">List of survival games ordered by duration (best first)</param>
        public void Initialize(List<Game> games)
        {
            try
            {
                ...
                {
                    ShowError("No Survival games found");
                    return;
                }
        ...
        public void ShowLoading()
        {
            ...
            LoadingText.Text = "Loading Survival leaderboard...";
